...
public class PRTeamChat implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (playerData.getSecondaryTeam().equals("PR-Team") || voidPlayer.isAduty()) {
            for (Player players : Bukkit.getOnlinePlayers()) {
                ...
                if (playersData.getSecondaryTeam() != null) {
                    ...
                    if (playersData.getSecondaryTeam().equalsIgnoreCase("PR-Team") || playersData.getPermlevel() >= 70) {
                        if (playersData.getSecondaryTeam().equals("PR-Team") || voidPlayers.isAduty() || playersData.getPermlevel() >= 70) {
                            players.sendMessage("§6PRTeam §8┃§e " + player.getName() + "§8:§7 " + Utils.stringArrayToString(args));
                        }
                    }
                }
            }
