...
public enum Workstation {
    BULLETPROOF("Schutzwesten", new Location(Bukkit.getWorld("World"), 345, 67, -109), RoleplayItem.KEVLAR, RoleplayItem.BULLETPROOF, 5, 1),
    KEVLAR("Kevlar", new Location(Bukkit.getWorld("World"), 221, 67, 138), RoleplayItem.ARAMID, RoleplayItem.KEVLAR, 50, 1),
