...
import de.polo.core.utils.BookSerializer;
...
public class NewsManager {
    ...
    private void loadBooksFromDatabase() {
        books.clear();
        Main.getInstance().getCoreDatabase().queryThreaded("SELECT * FROM news_store")
    ...
    public void removeBook(ShopBook shopBook) {
        ...
        Main.getInstance().getCoreDatabase().deleteAsync("DELETE FROM news_store WHERE id = ?", shopBook.getId());
    }
}
