...
public class GottesdienstCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        Bukkit.broadcastMessage("§8[§6Gottesdienst§8]§e " + factionManager.getRankName(playerData.getFaction(), playerData.getFactionGrade()) + " " + playerData.getFirstname() + " " + playerData.getLastname() + " ruft alle zum Gottesdienst in der Kirche auf. Jeder ist herzlichst eingeladen, den Gottesdienst beizuwohnen.");
        return false;
    }
}
