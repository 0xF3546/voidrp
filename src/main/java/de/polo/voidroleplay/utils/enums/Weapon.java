...
@Getter
public enum Weapon {
    ASSAULT_RIFLE("§cPhantom-4", "Phantom-4", Material.DIAMOND_HORSE_ARMOR, Sound.ENTITY_FIREWORK_ROCKET_BLAST, 0.7f, 25, 12, 1.25f, 4, 4, 0, false),
    ...
    MARKSMAN("§cVortex-10", "Vortex-10", Material.LEATHER_HORSE_ARMOR, Sound.ENTITY_FIREWORK_ROCKET_BLAST, 0.9f, 4, 24, 3, 5, 8, 0, false),
